...
// TOP NAV
// ─────────────────────────────────────────────────────────────────────────────
function TopNav({view,onNav,watchlistCount,unreadAlerts,onCmd,settings}) {
...
export default function App() {
  ...
  return (
    <div style={{minHeight:"100vh",background:"#0c111b",color:"#e2e8f0",fontFamily:"'DM Sans','Helvetica Neue',sans-serif",display:"flex",flexDirection:"column"}}>
      ...
      <TopNav view={view} onNav={setView} watchlistCount={watchlist.length} unreadAlerts={unreadAlerts} onCmd={()=>setCmdOpen(true)} settings={settings}/>
